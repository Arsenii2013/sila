...
class ev_seq_ctrl_generator#(
    ...
    task send_prog_ev(input event_generator_pkg::ev_t ev);
        write(BASE + PROG_EV, data_t'({1, ev}));
    endtask
