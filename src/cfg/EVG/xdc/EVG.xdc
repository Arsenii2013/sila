...
set_property LOC GTXE2_CHANNEL_X0Y7 [get_cells gtwizard_i/gtwizard_port_0/inst/EVG_gtwizard_port_0_i/gt0_EVG_gtwizard_port_0_i/gtxe2_i]
set_property PACKAGE_PIN AD6 [get_ports {SFP_RX_P[0]}]
set_property PACKAGE_PIN AD2 [get_ports {SFP_TX_P[0]}]
set_property LOC GTXE2_CHANNEL_X0Y6 [get_cells gtwizard_i/gtwizard_port_1/inst/EVG_gtwizard_port_1_i/gt0_EVG_gtwizard_port_1_i/gtxe2_i]
set_property PACKAGE_PIN AF6 [get_ports {SFP_RX_P[1]}]
set_property PACKAGE_PIN AE4 [get_ports {SFP_TX_P[1]}]
set_property LOC GTXE2_CHANNEL_X0Y5 [get_cells gtwizard_i/gtwizard_port_2/inst/EVG_gtwizard_port_2_i/gt0_EVG_gtwizard_port_2_i/gtxe2_i]
set_property PACKAGE_PIN AG4 [get_ports {SFP_RX_P[2]}]
set_property PACKAGE_PIN AF2 [get_ports {SFP_TX_P[2]}]
set_property LOC GTXE2_CHANNEL_X0Y4 [get_cells gtwizard_i/gtwizard_port_3/inst/EVG_gtwizard_port_3_i/gt0_EVG_gtwizard_port_3_i/gtxe2_i]
...
create_clock -period 8.000 -name REFCLK_SFP -waveform {0.000 4.000} -add [get_ports REFCLK_p]
...
set_multicycle_path -hold  4 -from [get_pins {evg_i/link_master_inst[*].link_master_i/measure_i/sampler_i/sample_reg[*]/C}]
set_multicycle_path -setup 5 -from [get_pins {evg_i/link_master_inst[*].link_master_i/sync_measure_i/sampler_i/sample_reg[*]/C}]
set_multicycle_path -hold  4 -from [get_pins {evg_i/link_master_inst[*].link_master_i/sync_measure_i/sampler_i/sample_reg[*]/C}]
...
set_multicycle_path -hold  4 -from [get_pins {evg_i/link_master_inst[*].link_master_i/system_packet_reciever_i/sub_delay_rx_fsm/param_reg[0][*]/C}]
set_false_path -to [get_pins evg_i/BUFGCTRL_inst/S0]
set_false_path -to [get_pins evg_i/BUFGCTRL_inst/S1]

set_clock_groups -name exclusive_local_clk -physically_exclusive -group local_clk -group gtwizard_i/gtwizard_port_0/inst/EVG_gtwizard_port_0_i/gt0_EVG_gtwizard_port_0_i/gtxe2_i/TXOUTCLK