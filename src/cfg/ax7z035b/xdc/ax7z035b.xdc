...
set_property -dict { PACKAGE_PIN Y11    IOSTANDARD LVCMOS33 } [get_ports { event_pulse }];
...
set_property LOC GTXE2_COMMON_X0Y2 [get_cells gtwizard_i/gtwizard_i/inst/common0_i/gtxe2_common_i]