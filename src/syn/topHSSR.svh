...
localparam HSSR_reg_map__device_numbers_e    SYSTEM_CSR_EVAL   = HSSR_reg_map__device_numbers__SYSTEM_CSR;
localparam HSSR_reg_map__device_numbers_e    DEVICE_INFO_EVAL  = HSSR_reg_map__device_numbers__DEVICE_INFO;
localparam HSSR_reg_map__device_numbers_e    EVR_EVAL          = HSSR_reg_map__device_numbers__EVR;
...
localparam COMMON       = 0;
localparam SYSTEM_CSR   = COMMON      + 1;
localparam DEVICE_INFO  = SYSTEM_CSR  + 1;
