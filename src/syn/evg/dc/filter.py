...
T_sample  = (1/175e6) * 2**10
T_analog  = 33e-3 # ms
T_digital = 2**12 # T_sample cycles
...
analog_response = step_response(analog, T=0.2)
#analog_response.sysname = "H(z) analog "
analog_response.plot()

digitalized_response = step_response(digitalized, T=0.2)
#digitalized_response.sysname = "H(z) digitalized "
digitalized_response.plot()

digital_response = step_response(digital, T=0.2)
